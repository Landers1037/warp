...
use crate::proto::{
    ...
    DiscardFilesRequest, DropCodebaseIndex, ErrorCode, FileStatusInfo, GetDiffState,
    GetDiffStateResponse, IndexCodebase, Initialize, InitializeResponse,
    ...
    UnsubscribeDiffState, WriteFile,
};
